...
Render::PrimitiveFactory* Render::PrimitiveFactory::Get()
{
...
Geometry* Render::PrimitiveFactory::GetPrimitiveGeometry(PrimitiveType primitiveType)
{
    return &PrimitiveFactory::Get()->m_geometries[primitiveType];
}

void Render::PrimitiveFactory::InitializePrimitiveGeometry()
{
    Render::PrimitiveFactory* pInstance = Render::PrimitiveFactory::Get();
    ...
    circle.indiciesNumber = sphere.indexes.size();
    ...
    sphere.indiciesNumber = sphere.indexes.size();
